...
emulation_data.calculate_ratio_by_redshifts(redshift, normalize=False)
...
thinning = 1
max_ntrain = 55
PCA_dict_cross,PCA_dict_cros_all = av.cross_validation(emulation_data=emulation_data, wanted_ntest=10, n_vali= 1,
                                 operator="DL", max_train_size=max_ntrain,interp_type="GP")
