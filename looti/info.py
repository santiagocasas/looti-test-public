...
__author__ = 'Santiago Casas'
__email__ = 'santiago.casas@cea.fr'
__year__ = '2019'
__url__ = 'https://github.com/santiagocasas/looti'
__description__ = 'Code package for Linear Operator and Optimal Transport Interpolation'
